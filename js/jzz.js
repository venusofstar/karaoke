(function(global, factory) {
  ...
  _for(_noteMap, function(k) {
    for (n = 0; n < 12; n++) {
      m = _noteMap[k] + n * 12;
      if (m > 127) break;
      _noteNum[k + n] = m; _noteNum[k + 'в™®' + n] = m;
      if (m > 0) {
        _noteNum[k + 'b' + n] = m - 1; _noteNum[k + 'в™­' + n] = m - 1;
        _noteNum[k + 'bb' + n] = m - 2; _noteNum[k + 'в™­в™­' + n] = m - 2; _noteNum[k + 'рќ„«' + n] = m - 2;
      }
      if (m < 127) {
        _noteNum[k + '#' + n] = m + 1; _noteNum[k + 'в™Ї' + n] = m + 1;
        _noteNum[k + '##' + n] = m + 2; _noteNum[k + 'в™Їв™Ї' + n] = m + 2; _noteNum[k + 'рќ„Є' + n] = m + 2;
      }
    }
  });
